  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-14 text-foreground">
      ...
      <div className="mt-6 space-y-4 text-sm leading-7 text-muted">
        ...
        <p>If you configure an AI provider, voice audio is sent to that provider for transcription and analysis. Raqet stores the transcript and generated debrief, but does not store raw audio after processing.</p>
