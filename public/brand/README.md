...
- `raqet-mark.svg` — primary standalone symbol, transparent background.
- `raqet-mark-mono.svg` — monochrome/currentColor version for flexible usage.
- `raqet-favicon.svg` — square icon version with off-white background.
- `raqet-mark-1024.png` — transparent PNG export.
- `raqet-mark-2048.png` — high-resolution transparent PNG export.
...
- Deep green: `#0e2d2b`
- Lime accent: `#9bdc00`
- Favicon background: `#f9faf7`

## Notes

The mark is based on the selected top-left concept: an abstract `R`, racket-head loop, shot trajectory, lime ball accent, and small net/string cross detail.
